...
public class TestPomFrameWork_WithDDF extends BaseClass
{
   static Sheet sh;
	...
	{
		FileInputStream file=new FileInputStream("C:\\Users\\HP\\eclipse-workspace\\selenium_14_15_2024\\TestData");
		...
		//---------------------------------------------------------------------------------
		 ...
		 String UNVALUE = UtilityClass.GEtTD(0, 0);
		 first.EnterUN(UNVALUE);
		 
		 Thread.sleep(1000);
		 
		 String PWDVALUE = UtilityClass.GEtTD(0, 1);
